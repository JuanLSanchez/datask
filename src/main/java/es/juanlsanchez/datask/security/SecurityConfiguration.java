...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    String projectId = resolve(ProjectResource.SECURITY_URL, ProjectResource.SECURITY_ID);
    ...
    http.authorizeRequests().antMatchers(HttpMethod.POST, projectUrl).hasAnyAuthority(ADMIN,
        MANAGER);
    http.authorizeRequests().antMatchers(HttpMethod.GET, projectId).hasAnyAuthority(ADMIN, MANAGER);
    http.authorizeRequests().antMatchers(HttpMethod.PUT, projectId).hasAnyAuthority(ADMIN, MANAGER);
    ...
    String budgetId = resolve(BudgetResource.SECURITY_URL, BudgetResource.SECURITY_ID);
    ...
    http.authorizeRequests().antMatchers(HttpMethod.GET, budgetId).authenticated();
    http.authorizeRequests().antMatchers(HttpMethod.PUT, budgetId).hasAnyAuthority(ADMIN, MANAGER);
